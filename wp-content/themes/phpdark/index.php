<?php get_header(); ?>
	...
	<section id="boxes">
		<div class="container">
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/php/2017/08/08/introduction-to-php-programming/" class="readmore">READ MORE</a>
			</div>
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/php/2017/09/27/php-array-declaration-and-defination/" class="readmore">READ MORE</a>
			</div>
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/category/php/php_oop/" class="readmore">READ MORE</a>
			</div>
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/project" class="readmore">READ MORE</a>
			</div>
	...
	<section id="boxes">
		<div class="container">
			<div class="box">
				...
				<a href="<?php bloginfo();?>/2018/09/01/introduction-to-html5/" class="readmore">READ MORE</a>
			</div>
			<div class="box">
			...
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/2018/09/02/ajax-introduction/" class="readmore">READ MORE</a>
			</div>
			...
			<div class="box">
				...
				<a href="<?php echo get_home_url(); ?>/database/mysql/2017/12/05/what-is-database-and-its-usage/" class="readmore">READ MORE</a>
			</div>
	...
	get_template_part('homepage/blog'); //search
