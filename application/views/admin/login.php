...
<body>
  ...
  <?php echo form_open('admin/admin/login',array('id'=>'accesspanel'));?>
  <h1 id="litheader"><i class="fa fa-user-secret" style="font-size: 25px;"></i>&nbsp;Admin Login Panel</h1>
  <div class="inset">
   <?php if($this->session->error): ?>
    <p id="message" style="text-align: center; color: red;"><?php echo $this->session->error; ?></p>
    <p> <br>
    <?php endif; ?>
    <input type="text" name="username" id="email" placeholder="Enter Username Here">
  </p>
  <p>
    ...
    <p class="p-container">
      <input type="submit" name="Login" id="go" value="Login Now">
    </p>
  </form>
