                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="post_title" class="form-control" id="exampleInputName1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="post_slug" placeholder="Example: php-learning-awesome"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tagid[]" class="form-control" id="tags-dropdown" multiple="multiple">
                                        ...
                                        <option value="<?php echo $tag->tagid; ?>"><?php echo  $tag->tag_name; ?>
                                        </option>
                                        <?php       } ?>
