                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         ...
                                                         <div class="modal fade" id="exampleModalCenter<?php echo $i+2; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                                            <?php echo form_open('admin/blog_category/edit/'.$blog_category->tbcid,array('class'=>''));?>
                                                        ...
                                                        <!-- edit end-->
                                                         ...
                                                         <a href="<?php echo base_url();?>admin/blog/delete_cat/<?php echo $blog_category->tbcid;?>" class="btn btn-icon btn-warning" onclick="return(confirm('are you sure to delete?'))"><i class="ik ik-trash"></i></a>
              ...
              <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                <?php echo form_open('blog/save_blog_category',array('class'=>''));?>
                            <div class="modal-dialog modal-dialog-centered" role="document">
