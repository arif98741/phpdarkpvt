            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Blog Categories will differentiate several posts</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="dt-responsive">
                        ...
                        <tbody>
                            <?php $i = 1; foreach ($blog_categories as $blog_category) { ?>


                                <tr>
                                    <td style="text-align: center;"><?php echo $i;?></td>
                                    <td><?php echo $blog_category->category_title;?></td>
                                    <td><?php echo date('d-m-y H:iA',strtotime($blog_category->created_at));?></td>
                                    <td><?php echo date('d-m-y H:iA',strtotime($blog_category->updated_at));?></td>
                                    <td>
                                       ...
                                       <div class="modal fade" id="exampleModalCenter<?php echo $i+2; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                        <?php echo form_open('admin/blog/update_blog_cat/'.$blog_category->tbcid,array('class'=>''));?>
                                        <div class="modal-dialog modal-dialog-centered" role="document">

                                            <div class="modal-content">
                                                <div class="modal-header bg-info">
                                                    <h5 class="modal-title " id="exampleModalCenterLabel">Edit Blog Category</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputName1">Category Title</label>
                                                        <input type="text" name="category_title" value="<?php echo $blog_category->category_title;?>" class="form-control" id="exampleInputName1" placeholder="Name">
                                                    </div>
                                                </div>
                                ...
                                <a href="<?php echo base_url();?>admin/blog/delete_blog_cat/<?php echo $blog_category->tbcid;?>" class="btn btn-icon btn-warning" onclick="return(confirm('are you sure to delete?'))"><i class="ik ik-trash"></i></a>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
    <?php echo form_open('admin/blog/save_blog_category',array('class'=>''));?>
    <div class="modal-dialog modal-dialog-centered" role="document">

        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title " id="exampleModalCenterLabel">Add Blog Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
