                                ...
                                <table id="data_table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url();?>assets/admin/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Tiger Nixon</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url();?>assets/admin/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url();?>assets/admin/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Ashton Cox</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url();?>assets/admin/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url();?>assets/admin/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Airi Satou</td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>33</td>
