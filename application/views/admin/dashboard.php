		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box blue-bg">
					...
					<div class="count"><?php echo $total_withoutfee;?></div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box green-bg">
					...
					<div class="count"><?php echo $total_withfee;?></div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box blue-bg">
					<i class="fa fa-ban"></i>
					<div class="count"><?php echo $total_apply;?></div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box green-bg">
					...
					<div class="count"><?php echo $total_receive[0]->total_receive;?></div>
