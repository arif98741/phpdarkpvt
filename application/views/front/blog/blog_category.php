<div class="container">
    <h2 class="text-center" style="">Blog for -<?php echo $title; ?></h2>
    <hr>
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <a
                href="<?php echo base_url(); ?>blog/view/<?php echo $value->blog_slug; ?>/<?php echo $value->blog_id; ?>"><img
                    ...
                    alt="<?php echo $value->blog_title; ?>- PHPDark.com" class="img-fluid blog-thumb"></a>
            ...
            <h4><a href="<?php echo base_url(); ?>blog/view/<?php echo $value->blog_slug; ?>/<?php echo $value->blog_id; ?>"
            ...
            <p><?php echo substr($value->blog_description, 0, 100); ?><a
    ...
    <p>
        ...
        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $previous_page; ?>"
        ...
        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $i; ?>"
            <?php if ($i == $page) : ?> style="font-size: 16px; font-weight: 900;" <?php endif; ?>
            class="btn btn-info btn-sm"><?php echo $i; ?></a>&nbsp;
        <?php  } ?>

        <?php if ($page != $pages) : ?>
        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $next_page; ?>"
