...
<div class="container">
  <h2 class="text-center" style="">Blog for -<?php echo $title;?></h2><hr>
  <div class="row">
    ...
    <p>
      <?php if($page != 1) :?>
        ...
        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $previous_page; ?>" class="btn btn-info btn-sm">Previous</a>&nbsp;
      <?php endif; ?>

      <?php
      for($i=1; $i <= $pages; $i++) { ?> 

        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $i; ?>" <?php if($i==$page): ?> style="font-size: 16px; font-weight: 900;" <?php endif; ?> class="btn btn-info btn-sm"><?php echo $i;?></a>&nbsp;
      <?php  }?>

      <?php if($page != $pages) :?>
        <a href="<?php echo base_url(); ?>blog/category/<?php echo $category_name; ?>/<?php echo $category_id; ?>/page/<?php echo $next_page; ?>" class="btn btn-info btn-sm">Next</a>
      <?php endif; ?>
