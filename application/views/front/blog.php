<div class="container">
    <h2 class="text-center" style="">Latest Blogs</h2>
    <hr>
    <div class="row">
    ...
    <p>
        <?php if ($page != 1) : ?>
            ...
            <a href="<?php echo base_url(); ?>blog/<?php echo $previous_page; ?>"
        ...
        for ($i = 1; $i <= $pages; $i++) { ?>
            ...
            <a href="<?php echo base_url(); ?>blog/<?php echo $i; ?>" <?php if ($i == $page): ?> style="font-size: 16px; font-weight: 900;" <?php endif; ?>
