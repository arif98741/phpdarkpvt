  ...
  <div class="row">
    <div class="col-md-9">
      <?php if($blog[0]->blog_attachment != '' || $blog[0]->blog_attachment != null): ?>
        <img src="<?php echo base_url(); ?>uploads/blog/fullwidth/<?php echo $blog[0]->blog_attachment; ?>" alt="<?php echo $blog[0]->blog_title; ?>- PHPDark.com" class="img-fluid blog-details-image" >
       ...
       <hr>
       <p class="text-center">
        <a href="<?php echo base_url(); ?>blog/category/<?php echo str_replace(' ', '-', $blog[0]->category_title); ?>/<?php echo $blog[0]->tbcid; ?>/page/1"><strong><?php echo $blog[0]->category_title; ?></strong>
